      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 mb-4">
              Master the game of kings with AI-powered analysis, interactive
              puzzles, and personalized learning paths.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {["Features", "Puzzles", "Analysis", "Play", "Pricing"].map(
                (item) => (
                  <li key={item}>
                    <a
                      href="#"
          ...
          <div>
            ...
            <ul className="space-y-3">
              {["Blog", "Tutorials", "Community", "FAQ", "Support"].map(
                (item) => (
                  <li key={item}>
                    <a
                      href="#"
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-center gap-3">
                ...
                <a
                  href="mailto:info@chessmaster.com"
                  className="text-gray-400 hover:text-yellow-400 transition"
                >
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="text-sm text-gray-500">
            &copy; {currentYear} ChessMaster. All rights reserved.
          </div>
